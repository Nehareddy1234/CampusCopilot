...
async function generateDailyDigest(scrapedData, apiKey) {
...
`;
    try {
        const client = new openai_1.default({ baseURL: "https://openrouter.ai/api/v1", apiKey });
        ...
        return `Error generating digest: ${error.message}`;
    }
}
