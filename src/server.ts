...
app.post('/chat', async (req: Request, res: Response) => {
  ...
  const system = `You are Campus Copilot. Today is ${currentDate}. You have access to both past and future assignments in this LMS data. Answer user queries about them accurately based on the context. Do not invent dates or discuss archived courses.\n\n${context}`;
